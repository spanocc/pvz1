...
QT_MOC_LITERAL(1, 7, 7), // "Destory"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 7) // "Bullet*"

    },
    "Bullet\0Destory\0\0Bullet*"
};
...
void Bullet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Destory((*reinterpret_cast< Bullet*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< Bullet* >(); break;
            }
            break;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bullet::Destory)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Bullet::Destory(Bullet * _t1)
{
