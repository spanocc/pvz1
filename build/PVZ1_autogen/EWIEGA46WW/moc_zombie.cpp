...
QT_MOC_LITERAL(1, 7, 7), // "Destroy"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 7), // "Zombie*"
QT_MOC_LITERAL(4, 24, 6), // "zombie"
QT_MOC_LITERAL(5, 31, 10) // "GameDefeat"

    },
    "Zombie\0Destroy\0\0Zombie*\0zombie\0"
    "GameDefeat"
};
...
void Zombie::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Destroy((*reinterpret_cast< Zombie*(*)>(_a[1]))); break;
        case 1: _t->GameDefeat(); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< Zombie* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (Zombie::*)(Zombie * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Zombie::Destroy)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Zombie::GameDefeat)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Zombie::Destroy(Zombie * _t1)
{
