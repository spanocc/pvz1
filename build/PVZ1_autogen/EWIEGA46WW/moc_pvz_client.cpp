...
QT_MOC_LITERAL(1, 10, 10), // "CreatPlant"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "line"
QT_MOC_LITERAL(4, 27, 6), // "column"
QT_MOC_LITERAL(5, 34, 10), // "plant_type"
QT_MOC_LITERAL(6, 45, 7) // "respond"

    },
    "PVZClient\0CreatPlant\0\0line\0column\0"
    "plant_type\0respond"
};
...
void PVZClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CreatPlant((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PVZClient::CreatPlant)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PVZClient::CreatPlant(int _t1, int _t2, int _t3, bool _t4)
{
