...
QT_MOC_LITERAL(1, 11, 13), // "ProduceBullet"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 3) // "pos"

    },
    "PeaShooter\0ProduceBullet\0\0pos"
};
...
void PeaShooter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ProduceBullet((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PeaShooter::*)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PeaShooter::ProduceBullet)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PeaShooter::ProduceBullet(const QPoint & _t1)
{
