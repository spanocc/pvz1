...
QT_MOC_LITERAL(1, 10, 10), // "ProduceSun"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3) // "pos"

    },
    "SunFlower\0ProduceSun\0\0pos"
};
...
void SunFlower::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ProduceSun((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SunFlower::*)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SunFlower::ProduceSun)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SunFlower::ProduceSun(const QPoint & _t1)
{
